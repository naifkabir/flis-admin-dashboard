    ...
    cell: ({ row }) => {
      return (
        <div className="flex flex-col">
          <span>{row.getValue("counselling_date")}</span>
        </div>
      );
    },
    filterFn: (row, id, value) => value.includes(row.getValue(id)),
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex flex-col">
          <span>
            <span className="mr-1.5">{row.getValue("counselling_time")}</span>
            {checkAmPm(row.getValue("counselling_time"))}
          </span>
        </div>
      );
    },
