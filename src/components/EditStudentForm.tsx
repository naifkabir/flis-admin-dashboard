...
const studentApproveFormScheam = z.object({
  ...
  hobbies: z.string().min(1, {
    message: "Required hobbies",
  }),
  talent: z.string().min(1, {
    message: "Required talent",
  }),
  ...
  permanent_post_office: z.string().min(1, { message: "Required post office" }),
  ...
  permanent_postal_code: z.string().min(1, { message: "Required postal code" }),
        ...
        <form
          ...
          <div className="mb-8 grid grid-cols-2">
            <h1 className="text-2xl font-semibold mb-16 text-gray-600 uppercase">
              Showing All Details of {data.first_name} {data.last_name}
            </h1>
