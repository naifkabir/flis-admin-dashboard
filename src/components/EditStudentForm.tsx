                ...
                <div className="">
                  <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                    <DialogTrigger asChild>
                      <Button variant="secondary" className="border">
                        Assign Fees Group<span className="text-red-500">*</span>
                      </Button>
                    </DialogTrigger>
                  ...
                  <div className="mt-4">
                    <textarea
                      ...
                      className="w-full h-[100px] border p-2 text-[13px] rounded cursor-not-allowed"
                      placeholder="Selected Groups will appear here..."
                    />
                  </div>
                </div>
                {/* <FormField
                  ...
                  render={({ field }) => (
                    <FormItem
                      ...
                      <div className="grid grid-cols-4 items-center gap-x-4">
                        ...
                        <FormControl className="col-span-3">
                          <input
                            ...
                            className="border rounded-none mb-0.5 px-2 py-1"
                          />
                        </FormControl>

                        <div className="col-span-3 max-h-[163px] border text-[13.5px] overflow-scroll">
                          <div className="space-y-1">
                            {filteredGroups.map((group: any) => (
                              <div
                                key={group._id}
                      ...
                      Apply the selected groups when user confirms
                      <button
                        type="button"
                        onClick={() => field.onChange(selectedGroups)}
